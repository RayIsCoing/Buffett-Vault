...
**反拒绝规则**：分析必须同时回答"为什么该买"和"为什么不该买"，然后给净判定。单方面拒绝 = 分析失败。

如果发现自己对 80%+ 的标的都给 Avoid/Watch，说明框架执行有偏差：

- 巴菲特错过 Google、Amazon、Microsoft，这三个是他公开承认的最大失误
- 巴菲特在 2016 年扩展能力圈买入 Apple，证明框架可以适应新领域
- "说 No 感觉安全，但错过 wonderful business 的代价可能是几百亿"
